...
public class RenderCommand extends ConfiguredCommand<OrcidConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<OrcidConfiguration> bootstrap,
                       Namespace namespace,
                       OrcidConfiguration configuration) throws Exception {
